      ...
      <fieldset>
        ...
        <div className="inputs">
          <label htmlFor="title">Título de la noticia:</label><br/>
            <input id='title'className='input' type="text" placeholder="Ej:Delfines asesinos" onChange={handleInputChange} value={data.title} name="title"/><br/>
          <label htmlFor="section">Escoja la sección a la que pertenecerá:</label><br/>
            <select id='section'className='input section' value={data.section} onChange={handleInputChange} name="section" >
              <option>Salud</option>
          ...
          <label htmlFor="body">Cuerpo de la noticia:</label><br/>
            <textarea id='body'name="body" cols='70' rows='10' placeholder="Ej:Ayer en playa paraíso una manada de tiburones asestó un duro golpe..." onChange={handleInputChange} className='input' value={data.body}/><br/>
          <label htmlFor="author">Nombre:</label><br/>
            <input id='author' type="text" placeholder="Ej:Pepito Perez" className='input' onChange={handleInputChange} value={data.author} name="author"/><br/>
          <label htmlFor="img">Sube una imagen(opcional):</label><br/>
            <input type="file" name='img'value={data.img} onChange={handleInputChange}/><br/>
      <button type="submit" disabled={btnDisabled}>Publicar noticia</button>
      </div>
      </fieldset>
       {message}
  </form>
